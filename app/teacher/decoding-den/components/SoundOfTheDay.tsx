...
export default function SoundOfTheDay({ phonemeData }: SoundOfTheDayProps) {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Main Grid: Left = Type/Frequency/Voicing, Right = Spelling Chart */}
      <div className="grid md:grid-cols-2 gap-4">

        {/* LEFT COLUMN: Phoneme Type, Frequency, Voicing (stacked, compact) */}
            ...
            <div className="bg-green-50 rounded-lg px-4 py-2 border-2 border-oceanBlue/40">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <span className="font-bold text-gray-700">{frequencyData.percent.toFixed(2)}%</span>
                  <span className="px-2 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-700">
                    #{frequencyData.rank}
                  </span>
                </div>
              </div>
              <p className="text-xs text-gray-500 italic text-right">Mines, Hanson & Shoup (1978)</p>
            </div>
          )}
              ...
              <div className="flex items-center justify-between">
                ...
                <p className="text-gray-700">
                  ...
                  <span className="text-sm text-gray-500 ml-1">
                    {phoneme.is_voiced ? '(vibrating)' : '(no vibration)'}
                  </span>
                </p>
              </div>
            </div>

...
export const stage4WeeklyData: WeeklyData[] = [
  ...
  },
  {
    ...
    focusWords: ['show', 'grow', 'snow', 'slow', 'know', 'flow', 'pie', 'tie', 'lie', 'die'],
    decodableText: 'I know the snow will grow slow. Show me the flow! Can I have pie? Tie it and lie down.',

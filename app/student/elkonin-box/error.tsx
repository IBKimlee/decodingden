  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-100 via-pink-50 to-blue-100 flex items-center justify-center">
      <div className="text-center bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border-2 border-purple-300">
        ...
        <h2 className="text-2xl font-bold text-purple-800 mb-4">Oops! The Elkonin boxes got mixed up!</h2>
        <p className="text-gray-600 mb-6">Let&apos;s put them back together!</p>
        <button
          onClick={() => reset()}
